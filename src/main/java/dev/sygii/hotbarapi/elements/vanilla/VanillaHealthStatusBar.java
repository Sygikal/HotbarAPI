...
public class VanillaHealthStatusBar {
    public static class VanillaHealthStatusBarRenderer extends StatusBarRenderer {
        ...
        public VanillaHealthStatusBarRenderer() {
            super(Identifier.ofVanilla("health_renderer"), null, StatusBarRenderer.Position.LEFT, StatusBarRenderer.Direction.L2R);
        }
        ...
        public void render(MinecraftClient client, DrawContext context, PlayerEntity playerEntity, int x, int y, StatusBarLogic logic) {
            ...
            public final void renderHealthBar(DrawContext context, PlayerEntity player, int x, int y, int lines, int regeneratingHeartIndex, float maxHealth, int lastHealth, int health, int absorption, boolean blinking)*/
